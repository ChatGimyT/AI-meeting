...
const brief = {
  ...
  recipients:          arr(src.recipients || src.email_to || src['مستلمو التقرير']),
  recipients_cc:       arr(src.recipients_cc || src.email_cc || src['نسخة إلى']),
  recipients_bcc:      arr(src.recipients_bcc || src.email_bcc || src['نسخة مخفية']),
